      ...
      <div className="flex-1 flex flex-col items-center justify-center space-y-8">
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground text-sm max-w-xs">
            Toque no botão abaixo para capturar suas emoções de forma segura e
            privada
          </p>
        </div>
        ...
        <div className="relative flex flex-col items-center">
          <button
            ...
            aria-label="Vamos registrar seu momento"
          >
            <img
              src="/capture-empathetic.svg"
              alt="Toque aqui"
              className="w-32 h-32 transition-transform hover:scale-105"
            />
          </button>
